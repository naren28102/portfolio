      ...
      <div className="container mx-auto flex pl-8 lg:pl-16 min-h-[90vh] items-center justify-between px-12">
        ...
        <div className="flex-9 pr-3 lg:pr-16">
          ...
          >
            {/* GitHub Button */}
            <motion.a
              href="https://github.com/naren28102"
              target="_blank"
            ...
            {/* LinkedIn Button */}
            <motion.a
              href="https://www.linkedin.com/in/narendran597/"
              target="_blank"
              rel="noopener noreferrer"
              variants={{
                hidden: { opacity: 0, y: 20 },
            ...
            {/* Resume Button */}
            <motion.a
              href="https://drive.google.com/file/d/1swj4BB1YDiAcwfkwbDFYTfHc0flHiH-p/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              variants={{
                hidden: { opacity: 0, y: 20 },
            ...
            {/* Contact Button */}
            <motion.a
              href="mailto:nareshnarendran597@gmail.com"
              variants={{
                hidden: { opacity: 0, y: 20 },
                visible: { opacity: 1, y: 0 },
              }}
