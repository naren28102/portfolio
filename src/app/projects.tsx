...
const PROJECTS = [
  {
    ...
    tech: "Java, Spring Boot, MySQL, RESTAPIs",
    desc: " Developed a scalable backend for an e-commerce system using Spring Boot and MySQL, following SOLID principles and applying design patterns like Factory, Strategy, and Singleton.Implemented RESTful APIs for product, customer, order, and payment management, supporting CRUD operations and order tracking.Integrated JWT-based authentication and role-based access control for Admin and Customer users.Designed database schema and optimized queries for efficient data retrieval and integrity.Delivered a modular and reusable backend, enabling seamless front-end integration and improved maintain-ability.",
   
    github: "https://github.com/naren28102/e-commerance-java-backend",
    live: null
  },
];
